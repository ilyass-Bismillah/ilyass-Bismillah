...
const ilyass = {
  ...
  owns:      "data modeling → API design → UI → deployment",
...
| | Role | Where | When |
|:--|:--|:--|:--|
| 📊 | **Web Developer** | Digst Media · *Contract* | `May 2026 — Sep 2026` |
...
### 🧠 BuildFormAI
`AI-Powered SaaS` · **2025**

An AI form and workflow builder that turns natural-language prompts into customizable, production-ready forms. AI-generated drafts, conditional logic, multi-step flows, public sharing, response analytics, Stripe payments and a developer-friendly REST API.
...
Social media intelligence for creators, marketers and agencies — surfacing emerging viral content across TikTok, Reels and Shorts, and analyzing what drives it: hooks, engagement, audio and hashtags.
